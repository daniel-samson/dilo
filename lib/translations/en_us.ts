...
export const en_us_translations = {
  ...
  "accepted_unless": ":attribute must be accepted unless :other is in :values.",
  ...
  "alpha_dash": ":attribute must be alpha-numeric with dashes and underscores.",
  ...
  "before_or_equal": ":attribute must be a valid date before or equal to :date",
  ...
  "missing_with_all": ":attribute must not be present when all of :values are",
  ...
  "present_all": ":attribute must be present when all of :values are present.",
