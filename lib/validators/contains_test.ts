...
Deno.test("contains: is present as array", () => {
  ...
  let actual = contains.validate({ foo: ["bar"] }, {
    attribute: "foo",
    values: ["bar"],
  });
  ...
  actual = contains.validate({ foo: ["bar", "baz"] }, {
    attribute: "foo",
    values: ["bar"],
  });
...
Deno.test("contains: is not present as array", () => {
  const contains = new Contains();
  let actual = contains.validate({ foo: ["baz"] }, {
    attribute: "foo",
    values: ["bar"],
  });
  ...
  actual = contains.validate({ foo: ["baz"] }, {
    attribute: "foo",
    values: ["qux"],
  });
  assertEquals(actual, "foo.contains");
...
Deno.test("contains: is present as string", () => {
  ...
  actual = contains.validate({ foo: "bar" }, {
    attribute: "foo",
    values: ["qux"],
  });
  assertEquals(actual, "foo.contains");
